...
struct RegisterAccount: View {
    ...
    var body: some View {
        NavigationStack{
                        ...
                        VStack{
                            ...
                            HStack{
                                ...
                                SecureField(LocalizedStringKey("txt_confirm_pass"), text: $registerVM.confirmPassword)
                                    .onChange(of: registerVM.confirmPassword){ oldValue, newValue in
                                        registerVM.validateFields()
                                    }
            ...
            .background( registerVM.loading ? Color.black.opacity(0.2): nil )
            .ignoresSafeArea()
        }
